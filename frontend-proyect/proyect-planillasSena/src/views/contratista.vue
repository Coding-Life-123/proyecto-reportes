...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <nav class="menu">
      ...
      <a class="menu-item active">Listado Contratistas</a>
      <a class="menu-item">Aprobaciones <span class="badge">12</span></a>
      <a class="menu-item">Documentación</a>

      <p class="menu-title">Sistema</p>

      <a class="menu-item">Ajustes</a>
      <a class="menu-item">Centro de Ayuda</a>
    </nav>
